...
PARAMETER {
	...
	:GABA Weight
	initW = 1.06 : 5.0/4.71 : 3.0 : 4.0 : 5.0 : 4.2 : 3.5 :4.5 : :  :  3 :  2.5 : 5
	fmax = 3 : 2.85 :4 : 3 : 3
	fmin = .8
...
DERIVATIVE release {
	...
	W' = limitW*eta(capoolcon)*(lambda1*omega(capoolcon, threshold1, threshold2)-lambda2*GAP1(GAPstart1, GAPstop1)*W)
