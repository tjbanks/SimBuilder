...
PARAMETER {
	...
	lambda1 = 20 : 60 : 12 :80: 20 : 15 :8 :5: 2.5
	lambda2 = .03
	threshold1 = 0.3 : 0.4 :  0.45 : 0.35 :0.35:0.2 :0.50 (uM)
	threshold2 = 0.4 : 0.55 : 0.50 : 0.40 :0.4 :0.3 :0.60 (uM)

	initW = 0.667 : 1.5/2.25 :  0.9 : 0.8 : 2 : 10 : 6 :1.5
...
DERIVATIVE release {
	...
	W' = limitW*eta(capoolcon)*(lambda1*omega(capoolcon, threshold1, threshold2)-lambda2*W)	  : Long-term plasticity was implemented. (Shouval et al. 2002a, 2002b)
